...
while menu_principal not in '1,2,3':
        texto = ('\nOpção inválida!\n')
        escrita_rpg(texto)
        texto = ('Digite apenas uma das opções do menu principal.\nNúmero 1 número 2 ou número 3.')
        escrita_rpg(texto)
        print('\n')
        print('='*69)
        print('\n')
...
-########++-----.--+----..--+#-....-+#++++++---+-+++++++++++++++++++++++-#++##.##+#+###-#-+##+-##-#--+#--#######++######+++#####+##+++++++++++++++++++++++#++++.
  ...
  texto = ('\nNão tente bugar o jogo apertando a tecla enter\nsem escolher uma das opções do menu principal.\n')
  escrita_rpg(texto)
...
while escolha not in '1,2':
        texto = ('\nOpção inválida!\n')
        escrita_rpg(texto)
        texto = ('Digite apenas número 1 ou número 2 para continuar o jogo.')
        escrita_rpg(texto)
        print('\n')
        print('='*182)
        print('\n')
...
\n''')
  ...
  print('='*182)
  print('\n')
  texto = (f'{personagem} entrou na rua 96, foi em direção a praia e deu de cara com o guardião elemental da água, prepare-se para a batalha!\n')
  escrita_rpg(texto)
  texto = (f'O guardião elemental da água saiu do mar, e com a calda longa dele, desferiu um ataque giratório em {personagem}.\n\n')
  escrita_rpg(texto)
  texto = (f'O que {personagem} vai fazer?\n\n')
  escrita_rpg(texto)
...
if escolha == '1':
    ...
    pygame.mixer.music.load('Game over.mp3')
    pygame.mixer.music.play()
    texto = (f'{personagem} tentou escalar a montanha montado em seu cavalo cansado pé de pano.\n')
    escrita_rpg(texto)
...
escrita_rpg(texto)
texto = ('Devido ao pouco tempo entre família, trabalho e faculdade, consegui concluir apenas 3 capítulos da história.\n')
escrita_rpg(texto)
...
escrita_rpg(texto)
texto = (f'Obrigado por jogar meu jogo {personagem}, até a próxima ^.^\n\n\n')
escrita_rpg(texto)
print('='*182)
time.sleep(2)
texto = ('''
